...
let seventeen = document.getElementById("pack17")
let eighteen = document.getElementById("pack18");
let nineteen = document.getElementById("pack19");
let twenty = document.getElementById("pack20");
let twentyOne = document.getElementById("pack21");
let twentyTwo = document.getElementById("pack22");
let twentyThree = document.getElementById("pack23");
let twentyFour = document.getElementById("pack24");
let twentyFive = document.getElementById("pack25");
let twentySix = document.getElementById("pack26");
let twentySeven = document.getElementById("pack27");
let twentyEight = document.getElementById("pack28");
let twentyNine = document.getElementById("pack29");
let thirty = document.getElementById("pack30");
let thirtyOne = document.getElementById("pack31");
let thirtyTwo = document.getElementById("pack32");
let thirtyThree = document.getElementById("pack33");
let thirtyFour = document.getElementById("pack34")
...
function makePairs(pack,card1,card2,packNum) {
    ...
    if (pack.includes(card1) && !pack.includes(card2)) {
        ...
        console.log(packNum + " - " + card1 + " , " + card2)
